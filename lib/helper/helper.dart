...
class TSizes {
  ...
  // Button sizes
  static const double buttonHeight = 48.0; // Material minimum tap target
  ...
  // Border radius
  static const double borderRadiusXs = 4.0; // subtle rounding (chips, tags)
  static const double borderRadiusSm = 8.0; // cards, small containers
  static const double borderRadiusMd = 12.0; // buttons, input fields
  static const double borderRadiusLg = 16.0; // bottom sheets, modals
  static const double borderRadiusXl = 24.0; // large cards, dialogs
  static const double borderRadiusXxl = 32.0; // pill-shaped containers
  static const double borderRadiusFull =
      100.0; // fully rounded / circle buttons
}
